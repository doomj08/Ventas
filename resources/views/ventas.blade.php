        ...
        <table class="table table-bordered dataTable">
            ...
            <tr role="row" class="odd" v-for="(producto,index) in productos">
                ...
                <td>
                    ...
                    <button style="width: 50%;" class='btn btn-primary ' v-on:click="filteredPosts;producto.vendido += contar[index]*1;producto.cantidad -= contar[index]*1;sumatotal( producto.vendido*producto.precio)"  :disabled="producto.cantidad-contar[index]*1<0||!contar[index]">
                        Agregar
                    </button>
                </td>
